...
from tools.agent.model_connect4 import Connect4Model, objective_function_for_policy, \
    objective_function_for_value
from tools.config import Config
from tools.lib import tf_util
from tools.lib.data_helper import get_game_data_filenames, read_game_data_from_file, \
    get_next_generation_model_dirs
from tools.lib.model_helpler import load_best_model_weight
from tools.env.connect4_env import Connect4Env, Player
...
class OptimizeWorker:
    ...
    def load_model(self):
        from tools.agent.model_connect4 import Connect4Model
